...
export default function (app) {
    ...
    const jobStatuses = sequelizeClient.define('job_statuses', {
    ...
    jobStatuses.associate = function (models) {
        // Define associations here
        // See http://docs.sequelizejs.com/en/latest/docs/associations/
        jobStatuses.hasMany(models.jobs, { foreignKey: 'statusId', targetKey: 'id', as: 'jobStatuses' })
    }
